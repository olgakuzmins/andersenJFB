...
public class CustomArrayList<T> {
  ...
  public void add(T element, int index) {
    ...
    if ((index < 0) || (index > elementsAmount)) {
      throw new IndexOutOfBoundsException(
          "Index must be between 0 and " + elementsAmount + ", your index is " + index);
    }
  ...
  public void add(T[] elements, int startIndex) {
    ...
    if ((startIndex < 0) || (startIndex > elementsAmount)) {
      throw new IndexOutOfBoundsException(
          "Index must be between 0 and " + elementsAmount + ", your index is " + startIndex);
    }
  ...
  // the value of element will be put at the index cell, if index cell has value, it will be
  ...
  public void put(T element, int index) {
    ...
    if ((index >= 0) && (index < elementsAmount)) {
      ...
      throw new IndexOutOfBoundsException(
          "Index must be between 0 and " + (elementsAmount - 1) + ", your index is " + index);
  }

  // the array will be put, starting at the index cell, if index cell has value, it will be replaced
  // by new value
  public void put(T[] elements, int startIndex) {
    ...
    if ((startIndex >= 0) && (startIndex < elementsAmount)) {
      ...
      throw new IndexOutOfBoundsException(
          "Index must be between 0 and " + (size() - 1) + ", your index is " + startIndex);
  }
